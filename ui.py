...
class LogWidget(QTextEdit):
    ...
    def _next(self):
        ...
        elif tl.startswith("jarvis:") or tl.startswith("alice:"): self._tag = "ai"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure A.L.I.C.E. before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected — ALICE ready")
...
class MainWindow(QMainWindow):
    ...
    def _build_header(self) -> QWidget:
        ...
        title = QLabel("A.L.I.C.E")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        title.setFont(QFont("Courier New", 17, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        mid.addWidget(title)
        sub = QLabel("Artificial Logic Integrated Cybernetic Entity")
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. ALICE online.")
